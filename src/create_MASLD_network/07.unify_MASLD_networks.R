...
# edge and node attributes keep the information of the initial networks from
...
#
# The directed and undirected unified networks include the same amount of nodes 
# but different number of edges.
#
################################################################################
...
################################################################################
#
# 2. Unification of downstream MASLD networks
#
################################################################################
...
################################################################################
# 3: Unification of downstream MASLD networks
################################################################################
...
length(V(downstream_unified_network))
# 3201
print('length of the unified upstream network:')
length(V(upstream_unified_network))
# 972
...
################################################################################
#
# 4. Construct of the unified network.
#
################################################################################
...
length(V(unified_directed_network))
# 3701
...
print('length of the unified network:')
length(V(unified_undirected_network))
