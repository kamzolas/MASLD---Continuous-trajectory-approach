...
################################################################################
#
# 2. Loading of the interaction databases (sif files derived from PathwayCommons) 
...
################################################################################
#
# 3. Loading of the Omnipath database + filtering + modification of complexes.
...
################################################################################
#
# 4. Creation of the reference super-network
#
################################################################################
