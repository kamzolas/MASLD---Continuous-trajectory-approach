...
tmp_dir <- '../../results/wgcna_and_linear_modelling/grid_params/4_180/'
filename <- paste(tmp_dir, 'module_variable_coefficients_FINAL.tsv', sep='')
...
filename <- paste(tmp_dir, 'filtered_modules.tsv',sep='')
...
#
################################################################################
de_analysis_df <- read.csv('../../results/pseudo_bulk_analysis/deseq_results_SW_vs_previous.csv')
...
#
################################################################################
output_dir <- paste('../../results/pseudo_bulk_analysis/networks/de_and_msviper', sep='')
