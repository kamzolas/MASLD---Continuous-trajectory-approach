...
# Description
################################################################################
# This script can be used to plot the squared errors of models generated in the
# previous stop for all the combinations of WGCNA parameters, in order to find
...
main_dir <- '../../results/ucam_sanyal/wgcna_and_linear_modelling/grid_params'
