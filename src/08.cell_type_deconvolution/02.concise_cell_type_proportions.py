...
# Description
###############################################################################
# This script uses the consensus cell type proportions generated in the previous
# step to calculate the proportions for groups of cell types, in order to create 
# a more concise description of them. The main categories of cell types that are
# used here are: Hepatocytes, Endothelial cells, Fibroblasts, Cholangiocytes,
# Lymphoid cells, Macrophages and Myeloid cells.
# Outputs:
# - Concise cell type proportion per sample (tsv format).
# - Concise cell type proportions per SW (plots in pdf).
###############################################################################
...
if __name__ == "__main__":
    ...
    ###########################################################################
    # 1. Calculation of consensus cell type proportions for groups of cell types
    ###########################################################################
