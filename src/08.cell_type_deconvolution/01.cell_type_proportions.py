...
if __name__ == '__main__':
    ...
    files = os.listdir(main_dir+'matrices/')
    matrices = {}
    for f in files:
        key = f.split('.')[0]
    ...
    tmp_df.to_csv(main_dir+'cell_proportions_raw.tsv', sep='\t')
    '''
    ...
    prop_per_sw_df.to_csv(main_dir+'cell_type_proportions_per_sw.tsv', sep='\t')
