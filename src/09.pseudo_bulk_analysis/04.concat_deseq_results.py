...
# Description:
###############################################################################
# This scirpt aggregates the results of differential expression analysis of
# the pseudo bulk samples, which have been performed 30 times, into a single 
# matrix to proceed with the analysis. The differentiation levels of genes
# are calculated as the average log2 fold change across all 30 trials.
# Outputs:
# - A tsv file which contains the consensus results.
###############################################################################


if __name__ == "__main__":
    
    data_dir = '../../results/ucam_sanyal/pseudo_bulk_analysis/all_de_results/'
    ...
    df.to_csv(output_dir+'de_results.csv', sep=',')