...
# Description:
###############################################################################
# This scirpt aggregates the samples generated in the previou step (for each
# sliding window) in a unique matrix and creates the respective metadata file.
# Outputs:
# - 30 pairs of count matrices and metadata files for the pseudo bulk samples.
###############################################################################


if __name__ == "__main__":
    
    data_dir = '../../results/ucam_sanyal/pseudo_bulk_analysis/pseudo_bulk_RNAseq/'
    output_dir = '../../results/ucam_sanyal/pseudo_bulk_analysis/pseudo_bulk_RNAseq_datasets/'
