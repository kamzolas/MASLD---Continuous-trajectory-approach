suppressMessages(library(Rcpp)) # 1.1.0
...
# Description
################################################################################
# Calculation of semantic similarities of MASLD network nodes, using three metrics
# from the GOSemSim package.
# Output files:
# - NxN similarity matrices for the three selected metrics
################################################################################
...
output_dir = '../../results/ucam_sanyal/networks/semantic_similarities/'
