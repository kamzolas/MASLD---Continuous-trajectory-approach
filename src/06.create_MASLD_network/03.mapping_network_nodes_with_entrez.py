...
# Description:
###############################################################################
# Mapping of gene symbols that are included as nodes in the MASLD network 
# to entrez ids. Genes for which there is not any entrez id will be removed
# from the network, as there is not any functional annotation for them. 
# Outputs:
