...
# Description
################################################################################
# Integration of semantic similarities into MASLD network edges. So far distinct
# components of the MASLD network have been generated, so these subnetworks are 
# used as inputs here to enrich their edges with the similarity scores of 
# interactors. The unification of all these components into a global network is 
